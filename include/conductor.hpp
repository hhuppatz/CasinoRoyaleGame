...
template<typename T>
void conductor::register_component()
{
...
template<typename T>
void conductor::remove_component(entity entity)
{
...
template<typename T>
T& conductor::get_component(entity entity)
{
    return m_component_manager->get_component<T>(entity);
}

template<typename T>
component_type conductor::get_component_type()
{
    return m_component_manager->get_component_type<T>();
}

template<typename T>
std::shared_ptr<T> conductor::register_system()
{
